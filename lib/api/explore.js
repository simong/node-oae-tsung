...
/**
 * User loads the explore page
 *
 * @param  {Session}    session     A Tsung session
 */
var load = module.exports.load = function(session) {
    var tx = session.addTransaction('explore_load');
    tx.addRequest('GET', '/api/me');
};

/**
 * The user executes a search request from the explore page
 *
