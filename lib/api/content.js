 ...
 * @param  {String}     contentID a variable that represents a content item.
 */
var download = module.exports.download = function(session, contentID) {
    var tx = session.addTransaction('content_item_download');
    tx.addRequest('GET', '/api/content/' + contentID + '/download');
};
