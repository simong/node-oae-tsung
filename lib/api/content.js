...
var profile = module.exports.profile = function(session, contentId) {
    return ApiUtil.profile('content', session, contentId);
};
 ...
 *
 * @param  {Session}    session         The Tsung session
 * @param  {String}     resourceId      The id of the content whose access to update
 ...
 */
var createLink = module.exports.createLink = function(session, displayName, visibility, link, viewers) {
 ...
 * @return {Object}                 An object with field `id` that specifies the id of the created link
 */
var createDocument = module.exports.createDocument = function(session, displayName, visibility, viewers) {
