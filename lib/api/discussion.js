...
var share = module.exports.share = function(session, contentId, shareWith) {
    return ApiUtil.share('discussion', session, contentId, shareWith);
};
 ...
 * @param  {String}     [body]          Defaults to a random long string
 ...
 * @param  {String[]}   [managers]      The managers of the discussion
 * @return {Object}                     An object with field `id` whose value is the generated id of the discussion that was just created
 */
var create = module.exports.create = function(session, displayName, description, visibility, members, managers) {
