 ...
 * @return {Object}                 An object containing field `nextStart` which determines what value can be used for the `start` parameter in future scrollDown invocations
 */
var notifications = module.exports.notifications = function(session) {
	...
	return {'nextStart': _notificationsRequest(tx)};
};
 ...
 * @return {Object}                 An object containing field `nextStart` which determines what value can be used for the `start` parameter in future scrollDown invocations
 */
var notificationsScroll = module.exports.notificationsScroll = function(session, start) {
    var tx = session.addTransaction('notifications_scroll');
    return {'nextStart': _notificationsRequest(tx, start)};
};
 ...
 * @param  {String}         [start]     The starting point of the notification scrolling. If unspecified, will start from the most recent
 * @return {String}                     The value that can be used to reference the next `start` value for the next page of notifications
 * @api private
 */
