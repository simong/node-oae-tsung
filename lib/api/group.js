 ...
 */
var create = module.exports.create = function(session, alias, displayName, description, visibility, joinable, managers, members) {
 ...
 */
var update = module.exports.update = function(session, groupId, fields) {
    var tx = session.addTransaction('group_update');
    tx.addRequest('POST', '/api/group/' + groupId, fields);
};
 ...
 */
var updateMembers = module.exports.updateMembers = function(session, group, members) {
    var tx = session.addTransaction('group_update_members');
